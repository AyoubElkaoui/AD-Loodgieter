        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Professionele loodgietersdiensten in regio Utrecht. Snelle hulp bij verstoppingen, lekkages, en installaties.",
              ...
              "areaServed": [
                "Maarssen", "Utrecht", "Nieuwegein", "Amersfoort", "Zeist", "Culemborg", "IJsselstein", "Woerden"
              ],
              "sameAs": [
          ...
          >
            ...
            <div className="flex space-x-4 justify-center p-4">
              <Link href="tel:+31640961848"
                ...
                ☎️ Spoed? Bel Nu - Binnen 30 minuten op locatie!
              </Link>
              <Link href="/contact"
            ...
            <div>
              ...
              <p className="text-gray-600">
                ...
                een <Link href="/diensten/installaties"
                          className="text-blue-500 hover:underline">installatie</Link> nodig heeft, wij staan binnen 30
                minuten voor uw deur.
              </p>
